...
\begin{itemize}
  ...
  \item We refactored significantly the proof of Theorem 1.5. We now have a Lemma 1.2 that proves a results regarding pivoting and Property 1.1. This is used in later proofs.
  ...
  \item We improved main of the proofs for completeness and clarity.
  \item We clarified the notations in Table 3.
  \item Replace the word triangular by trapezoidal where appropriate.
\end{itemize}
...
\begin{authorresponse}
  ...
  Case 1 in the previous proof was not actually needed. Indeed, following the argument in Case 3 of the previous proof, we can always pivot to bring a non-zero column to index 1. Then we pivot a row using Case 2. The new proof essentially follow the path of Case 3, making Case 2 a special case that is handled automatically.
...
\begin{authorresponse}
  We are not sure about the error the referee is referring to. That notation is consistent with Table 1. We added a clarification in the manuscript about this notation:\\
...
\begin{authorresponse}
  The results are not commonly published but they are not new.
\end{authorresponse}
